...
class DataExtractionService:
    ...
    def get_stations_info(self) -> List[Dict[str, Any]]:
        ...
        """
        try:
            # Consulta para obtener estaciones únicas
            query = "SELECT DISTINCT codigoestacion, nombreestacion, departamento, municipio, latitud, longitud WHERE departamento='CUNDINAMARCA'"
            results = self.client.query(self.dataset_id, query=query)
